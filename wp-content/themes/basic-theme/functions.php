...
function basic_theme_scripts() { 
	...
	// Google Fonts 
	wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900&display=swap', array(), _S_VERSION); 
 
	// Bootstrap CSS 
	wp_enqueue_style( 'bootstrap-css', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css', array(), _S_VERSION); 
	
	// Bootstrap Icons CDN
	wp_enqueue_style( 'bootstrap-icons', 'https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css', array(), _S_VERSION); 
 
	// CSS 
	wp_enqueue_style('testimonial-css', get_template_directory_uri() . '/assets/css/style.css', array(), _S_VERSION ); 
	...
	// JS
	wp_enqueue_script('testimonial-js', get_template_directory_uri() . '/assets/js/script.js'); 
	...
	add_action('acf/init', function(){
		if(function_exists('acf_register_block_type')) {
			acf_register_block_type([
				...
				'description' 		=> __('A custom ACF block for testimonials'),
				'render_template'	=> 'template-parts/blocks/testimonial-blocks/testimonial.php',
				'category' 			=> 'formatting',
				'keywords'			=> ['slider', 'testimonials'],
			]);
		}
	});
endif;